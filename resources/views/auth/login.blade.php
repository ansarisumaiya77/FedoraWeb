  ...
  <body class="body">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7 col-sm-12">
                    <div class="row mt-5">
                        <div class="col-md-10 col-sm-12 offset-1">
                            ...
                            <h1 class="py-2 pt-4">Login to Fedora</h1>
                ...
                <div class="col-md-4 col-sm-12 login-box2">
                    <h2 class="text-center my-4 mt-5">Login</h2>
                    {{-- <form method="POST">
                        <div class="row ">
                        ...
                        <div class="form-group col-md-12 col-xs-12">
                            <button type="submit" class=" btn btn-outline-custom btn-lg btn-block" name="btnregister">SignUp</button>
                        </div>
                        </div>
                    </form> --}}
